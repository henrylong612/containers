'''
This file implements the Heap data structure as a
subclass of the BinaryTree.
The book implements Heaps using an *implicit* tree
with an *explicit* vector implementation,
...
class Heap(BinaryTree):
    ...
    def __repr__(self):
        ...
        Thus, if you create a variable using
        the command Heap([1,2,3])
    ...
    def remove_min(self):
        ...
        3. "trickle down" the root node:
        recursively swap it with its largest child
